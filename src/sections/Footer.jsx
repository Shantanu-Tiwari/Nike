        ...
        <footer className="max-container">
            <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
                <div className="flex flex-col items-start">
                    ...
                    <p className="mt-6 text-base font-montserrat text-white-400 sm:max-w-sm">Get shoes ready at your nearest Nike store. Get rewards.</p>
                        ...
                        <div key={section}>
                            ...
                            <ul>
                                {section.links.map((link)=>(
                                    <li className="font-montserrat mt-3 text-white text-base leading-normal hover:text-slate-gray cursor-pointer" key={link.name}>
                                        <a>{link.name}</a>
                                    </li>
                                ))}
                            </ul>
